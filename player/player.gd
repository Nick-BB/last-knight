...
func update_ritual(delta: float) -> void:
	...
	ritual.damage_amount = ritual_damage # Igualou a variável do player.gd e do ritual.gd
	add_child(ritual) # Ritual anda com o player
...
func attack() -> void:
	...
	# Tocar animação do ataque para cima
	if Input.is_action_pressed("move_up") and Input.is_action_just_pressed("attack"):
		animation_player.play("attack_up_1")

	# Tocar animação do ataque para baixo
	if Input.is_action_pressed("move_down") and Input.is_action_just_pressed("attack"):
